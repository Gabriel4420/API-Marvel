...
async function fetchCards() {
  ...
  const urlAPI = "http://gateway.marvel.com/v1/public/characters?offset=" + offset + "&ts=" + timeStamp + "&apikey=" + publicKey + "&hash=" + hash;
  console.log(urlAPI);
...
function createPagesItem(data) {
  let lines = "";
  for (let i = 1; i <= catchData(data).length; i++) {
